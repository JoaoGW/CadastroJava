...
public class EntradaGUI extends JFrame implements ActionListener, IMenu
{
    // ============ INICIALIZADORES =============
    // menu inicial
    ...
    public CadastroAlunos ap = new CadastroAlunos();
    public EntradaGUI(String nomeStr){
    ...
    private void ConfirmaInserir(){
        ...
        ap.Cadastro(this.lerNome(),this.lerIdade(),this.lerRa(),this.lerSerie());
        for (int i=0; i<qntDisc; i++){
